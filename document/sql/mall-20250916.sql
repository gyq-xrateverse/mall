...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='案例分类表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='案例数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `case_data` VALUES (1,1,'AI生成视频案例1','<p>这是一个AI生成的精美视频案例，展示了人工智能在视频创作领域的强大能力。</p>','20250116/sample_cover_1.jpg','20250116/sample_video_1.mp4','AI,视频生成,创意',1250,89,695.00,1,1,'2025-09-16 01:45:38','2025-09-16 01:45:38'),(2,1,'AI生成视频案例2','<p>另一个令人惊叹的AI视频作品，体现了技术与艺术的完美结合。</p>','20250116/sample_cover_2.jpg','20250116/sample_video_2.mp4','AI,艺术,科技',980,67,515.00,1,1,'2025-09-16 01:45:38','2025-09-16 01:45:38'),(3,2,'AI生成视频案例3','<p>展示AI在商业视频制作中的应用实例。</p>','20250116/sample_cover_3.jpg','20250116/sample_video_3.mp4','AI,商业,营销',756,45,381.00,1,1,'2025-09-16 01:45:38','2025-09-16 01:45:38');
...
CREATE TABLE `ums_admin_login_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=416 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='后台用户登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-16  9:46:13
